...
async def root(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "노지스마트팜\nAI재배관리시스템", "active_page": "dashboard"}
    )
...
async def video(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "영상분석 - 노지스마트팜\nAI재배관리시스템", "active_page": "video"}
    )
...
async def moisture_nutrition(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "수분분석 - 노지스마트팜\nAI재배관리시스템", "active_page": "moisture-nutrition"}
    )
...
async def impact(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "영양분석 - 노지스마트팜\nAI재배관리시스템", "active_page": "impact"}
    )
...
async def yield_prediction(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "수확예측 - 노지스마트팜\nAI재배관리시스템", "active_page": "yield"}
    )
...
async def ai_diagnosis(request: Request):
    return templates.TemplateResponse(
        "ai_diagnosis.html",
        {"request": request, "title": "AI 진단 - 노지스마트팜\nAI재배관리시스템", "active_page": "ai-diagnosis"}
    )
...
async def ai_prescription(request: Request):
    return templates.TemplateResponse(
        ...
        {"request": request, "title": "AI 처방 - 노지스마트팜\nAI재배관리시스템", "active_page": "ai-prescription"}
    )
...
async def ai_knowledge(request: Request):
    return templates.TemplateResponse(
        "ai_knowledge.html",
        {"request": request, "title": "AI 지식 - 노지스마트팜\nAI재배관리시스템", "active_page": "ai-knowledge"}
    )
